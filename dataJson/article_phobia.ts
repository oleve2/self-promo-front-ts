...
const ArticlePhobia: ArticleFull = {
  ...
  headerText: 'Фобия',
  summary: [
    `На данный момент описано более 500 видов фобий. По данным ВОЗ около 7% населения страдает от фобии. Женщины страдают в 2 раза чаще мужчин.`,
  ],
  ...
  blockList: [
    ...
    {type: PassageType.image, text: '', image: article_phobia_pic1},
    ...
    {type: PassageType.image, text: '', image: article_phobia_pic2},
